...
void CChildView::OnLButtonDown(UINT nFlags, CPoint point)
{
    ...
    if (mGrabbedItem != nullptr && !mTransporterEnable)
    {
    ...
    else if (mGrabbedItem != nullptr && mTransporterEnable)
    {
        CMinionSetter visitor(&mCity);
...
/**
 *  Check option for viewing mouse history
 */
...
/**
 *  Set Checker for history
 * \param pCmdUI menu option to set check
 */
 ...
 *  uses a print box to display number of buildings.
 */
...
/**
 *  Add a transporter to the city.
 */
void CChildView::AddTransporter()
{
...
/**
 *  Checker for the transporter option
 * \param pCmdUI menu option to set check
 */
void CChildView::OnUpdateTransporterTransport(CCmdUI* pCmdUI)
{
    pCmdUI->SetCheck(mTransporterEnable);
    Invalidate();
}
...
{
    mTransporterEnable = !mTransporterEnable;
